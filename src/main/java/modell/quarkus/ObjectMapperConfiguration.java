...
public class ObjectMapperConfiguration {
    ...
    public ObjectMapper objectMapper() {
        ...
        hibernate6Module.configure(Hibernate6Module.Feature.REPLACE_PERSISTENT_COLLECTIONS, false);
        hibernate6Module.configure(Hibernate6Module.Feature.SERIALIZE_IDENTIFIER_FOR_LAZY_NOT_LOADED_OBJECTS, false);
        hibernate6Module.configure(Hibernate6Module.Feature.REQUIRE_EXPLICIT_LAZY_LOADING_MARKER, false);
