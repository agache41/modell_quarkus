package modell.quarkus.grid.contract.classes.header.annotation;

import modell.quarkus.grid.contract.classes.header.annotation.enums.CellDataType;
import modell.quarkus.grid.contract.classes.header.annotation.enums.ChartDataType;
import modell.quarkus.grid.contract.classes.header.annotation.enums.Filter;
import modell.quarkus.grid.contract.classes.header.annotation.enums.HPosition;
import modell.quarkus.grid.contract.classes.header.annotation.enums.SPosition;
import modell.quarkus.grid.contract.classes.header.annotation.enums.SortDirection;
